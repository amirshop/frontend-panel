<template>
  <div>
    ...
    <Modal
      ...
      :ok-button-props="{}"
    >
      <img class="w-2/3 mx-auto block mb-12 mt-20" src="/logo.png" alt="" />
      <Form layout="vertical" class="right-0">
...
.full-modal {
  ...
  .ant-modal-content {
    @apply flex flex-col rounded-0 w-100 absolute right-0 h-screen rounded !shadow;
  }
  .ant-modal-body {
    @apply flex-1;
  }
